...
gt_path = os.path.join(os.path.dirname(__file__), "splits", "endovis", "curve", "gt_poses_sequence1.npz")
gt_local_poses = np.load(gt_path, fix_imports=True, encoding='latin1')["data"]

our_path = os.path.join(os.path.dirname(__file__), "splits", "endovis", "curve", "pred_poses_sequence1.npz")
